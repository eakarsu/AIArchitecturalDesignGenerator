...
// v0 scaffold for: No structural-analysis hooks
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-structural-analysis-hooks/run.

export default function StructuralAnalysisHooksPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-structural-analysis-hooks/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No structural-analysis hooks</h1>
