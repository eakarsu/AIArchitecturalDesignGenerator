...
// v0 scaffold for: No AI structural feasibility checker
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-ai-structural-feasibility-checker/run.

export default function AiStructuralFeasibilityCheckerPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-ai-structural-feasibility-checker/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No AI structural feasibility checker</h1>
