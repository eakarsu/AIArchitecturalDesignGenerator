...
// v0 scaffold for: Design-to-CAD conversion targeting AutoCAD / Revit
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-design-cad-conversion-targeting-autocad/run.

export default function DesignCadConversionTargetingAutocadPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-design-cad-conversion-targeting-autocad/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>Design-to-CAD conversion targeting AutoCAD / Revit</h1>
