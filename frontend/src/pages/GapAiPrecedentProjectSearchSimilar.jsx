...
// v0 scaffold for: No AI precedent-project search (similar past projects)
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-ai-precedent-project-search-similar/run.

export default function AiPrecedentProjectSearchSimilarPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-ai-precedent-project-search-similar/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No AI precedent-project search (similar past projects)</h1>
